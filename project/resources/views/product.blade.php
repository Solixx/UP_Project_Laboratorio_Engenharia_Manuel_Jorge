    ...
    <div class="produto">
        <div class="container">
            ...
            <div class="col4 colL6 colM4 colS4 prodInfo">
                ...
                @section('prodDesc')
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati culpa nemo est atque iusto ducimus quam? Corrupti, iste illum? Deserunt, hic accusamus exercitationem eaque consequatur autem placeat ad neque veritatis?
                @endsection
                    ...
                    <div class="size">
                        @for ($i = 0; $i < 10; $i++)
                            <div class="sizeBoxSpace">  
                                @if ($i == 0)
                                    <div class="sizeBox sizeActive">{{ $i+36 }}</div>
                                @else
                                    <div class="sizeBox">{{ $i+36 }}</div>
                                @endif
                            </div>
                        @endfor
                    </div>
