...
@section('content')
    <div class="produto">
        <div class="container">
            <div class="col8 colL6 colM4 colS4 prodImgs">
                @for ($i = 0; $i < 4; $i++)
                    <img src="{{ asset('imgs/snekears.jpg') }}" alt="Produto">
                @endfor
            </div>
            <div class="col4 colL6 colM4 colS4 prodInfo">
                <h1>Product Name</h1>
                <p class="prodPrice">€100.00€</p>
                <hr>
                <p class="prodDescript">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati culpa nemo est atque iusto ducimus quam? Corrupti, iste illum? Deserunt, hic accusamus exercitationem eaque consequatur autem placeat ad neque veritatis?</p>
                <div class="colors">
                    <p>Colors</p>
                    <div class="color">
                        <div class="colorBox" style="background-color: #000000;"></div>
                        <div class="colorBox" style="background-color: #ffffff;"></div>
                        <div class="colorBox colorActive" style="background-color: #ff0000;"></div>
                ...
                <div class="sizes">
                    ...
                    <div class="size">
                        <div class="sizeBoxSpace">
                            <div class="sizeBox sizeActive">36</div>
                        </div>
                        <div class="sizeBoxSpace">
                            <div class="sizeBox">37</div>
                        </div>
                        <div class="sizeBoxSpace">
